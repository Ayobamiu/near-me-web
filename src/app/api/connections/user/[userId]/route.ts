...
export async function GET(
    ...
    try {
        ...
        const [sentConnectionsSnapshot, receivedConnectionsSnapshot] = await Promise.all([
        ...
        for (const doc of sentConnectionsSnapshot.docs) {
        ...
        for (const doc of receivedConnectionsSnapshot.docs) {
            const connectionData = doc.data();
            const connection: Connection = {
                id: doc.id,
                userId: connectionData.userId,
