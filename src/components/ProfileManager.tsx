  ...
  if (loading) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-0 sm:p-4">
        <div className="bg-white rounded-none sm:rounded-lg p-6 max-w-md w-full h-full sm:h-auto mx-0 sm:mx-4">
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Choose what personal information you want to share with other users:
                  </p>
                  
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        <h5 className="font-medium text-gray-900">Show Age</h5>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        <h5 className="font-medium text-gray-900">Show Email</h5>
                        <p className="text-sm text-gray-600">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>Note:</strong> These settings control what information is visible to other users in places. 
